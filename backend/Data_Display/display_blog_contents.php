...
class Blog_Title_Display extends Db_Connection{
    ...
    public function display_blog_title(){
        try{
            $this->execute_query();
        }
...
$display_blog_title = new Blog_Title_Display($blog_id);
$display_blog_title->display_blog_title();